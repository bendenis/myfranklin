...
function hfun_m1fill(vname)
  var = vname[1]
  return pagevar("menu3", var)
end
```

Which you can use like this `{{m1fill title}}`: **{{m1fill title}}**. Of course  in this specific case you could also have used `{{fill title menu3}}`: **{{fill title menu3}}**.
